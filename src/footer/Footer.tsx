    ...
    <div className={styles.Footer}>
      ...
      <div className={styles.Container}>
        <Button
          ...
          ExtraComponent={<FontAwesomeIcon icon={faGithub} size="2x" />}
        />
        <Button
          PropBtnStyle={styles.Btn}
          Href="https://instagram.com/serhii_iliniuk"
          ExtraComponent={<FontAwesomeIcon icon={faInstagram} size="2x" />}
        />
        <Button
          PropBtnStyle={styles.Btn}
          Href="https://twitter.com/SYliniuc"
          ExtraComponent={<FontAwesomeIcon icon={faTwitter} size="2x" />}
        />
        <Button
          PropBtnStyle={styles.Btn}
